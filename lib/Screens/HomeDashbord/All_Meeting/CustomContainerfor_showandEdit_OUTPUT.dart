                                          ...
                                          children: [
                                            ...
                                            Text(
                                              ...
                                              style: const TextStyle(
                                                fontSize: 17, // Adjust the font size for title
                                                fontWeight: FontWeight.bold, // Add other styling if needed
                                              ),
                                            ),
                                          ],
                                        ),
                                        subtitle: Padding(
                                          padding: const EdgeInsets.only(left: 40.0, top: 0.0, bottom: 0.0), // Adjust padding to reduce space
                                          child: TextFormField(
                                            ...
                                            maxLines: null,
                                            onChanged: (newValue) {
                                              onMessageChanged(index, message['speaker'], newValue);
                                            },
                                          ),
                                        ),
                                      )
...
class CustomPlayerForPlayOnly extends StatefulWidget {
  ...
  @override
  _CustomPlayerForPlayOnlyState createState() => _CustomPlayerForPlayOnlyState();
}
